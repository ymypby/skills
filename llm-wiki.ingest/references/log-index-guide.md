...
- **关联**: [综合分析 A](synthesis/a.md)

## Entities

### [实体名称](entities/xxx.md)
- **摘要**: 一行描述
- **关联**: [概念 A](concepts/a.md), [概念 B](concepts/b.md)
...
- **关联**: [架构分析](synthesis/architecture-analysis.md)

## Entities

### [Session](entities/session.md)
- **摘要**: 用户会话实体，包含 Token 追踪和超时管理
- **关联**: [Agent Decision Loop](concepts/agent-decision-loop.md), [Event Workflow](concepts/event-workflow.md)

### [User](entities/user.md)
- **摘要**: 系统用户实体
- **关联**: [认证流程](concepts/authentication-flow.md)
...
- [ ] 日期格式正确
- [ ] 新页面 relations 已填写完整
- [ ] 现有页面 relations 已修复（受本次 Ingest 影响的页面）
- [ ] index.md 的"关联"列表与页面 relations 一致
